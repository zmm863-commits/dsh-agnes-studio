 ...
 */
type TypeScriptVersionOption = 'auto' | (string & {}) | false;
...
type ResolveExtendsChainOptions = {
    typescriptVersion?: TypeScriptVersionOption;
};
 ...
 */
declare const resolveExtendsChain: (chain: TsconfigResult<TsConfigJson>[], options?: ResolveExtendsChainOptions) => TsconfigResult;
...
export { type FindTsconfigOptions, type GetExtendsChainOptions, type GetTsconfigOptions, type ReadTsconfigOptions, type ResolveExtendsChainOptions, type TsconfigCache, TsConfigJson as TsconfigJson, type TsconfigJsonResolved, type TsconfigResult, type TypeScriptVersionOption, findTsconfig, getExtendsChain, getTsconfig, isFileIncluded, readTsconfig, resolveExtendsChain, resolvePathAlias };
